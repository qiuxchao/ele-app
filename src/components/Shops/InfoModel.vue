...
<transition name="fade">
  ...
  <!-- 显示不显示取决于 showInfoModel 的值，而这个值由 x 号按钮和订餐页面控制 -->
  <div class="info-model" v-show="showInfoModel">
    ...
    <!-- 下方 x 号 -->
    <!-- 注册事件，在订餐页面将 x 号的值赋为 false，即关闭弹窗 -->
    <div class="brief-modal-close" @click="$emit('close')">
        <!-- x 号图片 -->
        <img src="https://fuss10.elemecdn.com/8/ba/bcfa8cc62b20e044bd2ea1c1c7f3dpng.png?imageMofr/format/webp/" alt="">
    </div>
...
export default {
  name: "InfoModel",
  props: {
    rst: Object, // 接收订餐页面传来的商家信息数据
    showInfoModel: Boolean  // 底部 x 按钮的开关
  }
};
</script>
